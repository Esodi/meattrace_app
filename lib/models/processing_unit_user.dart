class ProcessingUnitUser {
  ...
  factory ProcessingUnitUser.fromJson(Map<String, dynamic> json) {
    return ProcessingUnitUser(
      ...
      email: json['email'],
      processingUnitId: json['processing_unit_id'] is int ? json['processing_unit_id'] : int.parse(json['processing_unit_id'].toString()),
      processingUnitName: json['processing_unit_name'],
      role: json['role'],
      permissions: json['permissions'],
      granularPermissions: json['granular_permissions'],
      invitedById: json['invited_by_id'] != null ? (json['invited_by_id'] is int ? json['invited_by_id'] : int.parse(json['invited_by_id'].toString())) : null,
      ...
      isSuspended: json['is_suspended'] is bool ? json['is_suspended'] : json['is_suspended'].toString().toLowerCase() == 'true',
