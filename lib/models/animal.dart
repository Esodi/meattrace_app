...
class Animal {
  ...
  Animal copyWith({
    ...
    AnimalLifecycleStatus? lifecycleStatus,
    bool? isHealthy,
    bool? isSlaughteredStatus,
    bool? isTransferredStatus,
    bool? isSemiTransferredStatus,
    bool? isExternal,
    ...
    return Animal(
      id: id ?? this.id,
      abbatoir: abbatoir ?? this.abbatoir,
      ...
      slaughteredAt: slaughteredAt ?? this.slaughteredAt,
      animalId: animalId ?? this.animalId,
      animalName: animalName ?? this.animalName,
      breed: breed ?? this.breed,
      abbatoirName: abbatoirName ?? this.abbatoirName,
      ...
      usedInProduct: usedInProduct ?? this.usedInProduct,
      rejectionStatus: rejectionStatus ?? this.rejectionStatus,
      rejectedBy: rejectedBy ?? this.rejectedBy,
      rejectedAt: rejectedAt ?? this.rejectedAt,
      carcassMeasurement: carcassMeasurement ?? this.carcassMeasurement,
      slaughterParts: slaughterParts ?? this.slaughterParts,
      photo: photo ?? this.photo,
      lifecycleStatus: lifecycleStatus ?? this.lifecycleStatus,
      isHealthy: isHealthy ?? this.isHealthy,
      isSlaughteredStatus: isSlaughteredStatus ?? this.isSlaughteredStatus,
      isTransferredStatus: isTransferredStatus ?? this.isTransferredStatus,
      isSemiTransferredStatus:
          isSemiTransferredStatus ?? this.isSemiTransferredStatus,
