class Constants {
  ...
  // API Endpoints
  // NOTE: all endpoints below must start with '/' — Dio joins them onto
  // baseUrl with plain string concatenation (no separator inserted), and
  // baseUrl itself has no trailing slash.
  ...
  static const String notificationMarkAllReadEndpoint =
      '/notifications/mark-all-read/';
  static const String notificationPreferencesEndpoint =
      '/notifications/preferences/';
  static const String notificationRegisterDeviceEndpoint =
