...
class CustomIcons {
  ...
  static IconData get cattle => MdiIcons.cow;

  /// Pig Icon (24x24)
  static IconData get pig => MdiIcons.pig;

  /// Chicken/Poultry Icon (24x24)
  static IconData get chicken => MdiIcons.bird;

  /// Sheep Icon (24x24)
  static IconData get sheep => MdiIcons.sheep;

  /// Goat Icon (24x24)
  static IconData get goat =>
      MdiIcons.sheep; // MdiIcons might not have a goat, sheep is closest
  ...
  /// Abbatoir Icon (24x24)
  static IconData get abbatoir => MdiIcons.barn;

  /// Abattoir Icon (24x24)
  static IconData get abattoir => MdiIcons.warehouse;

  /// Processing Unit Icon (24x24)
  static IconData get processingUnit => MdiIcons.factoryIcon;

  /// Processing Plant Icon (Alias for processingUnit)
  static IconData get processingPlant => processingUnit;
  ...
  static IconData get beef => steak;

  /// Pork (alias for pig)
  static IconData get pork => pig;

  /// Mutton (alias for sheep)
  static IconData get mutton => sheep;

  /// Meat Cut (fallback)
  static const IconData meatCut = Icons.cut;

  /// Processed Meat (alias for sausage)
  static IconData get processedMeat => sausage;

  /// Slaughter Icon (Intuitive crossed katanas)
  static IconData get slaughter => MdiIcons.swordCross;
}
...
class MeatTraceIconsFallback {
  ...
  static const abbatoir = Icons.agriculture; // Placeholder
