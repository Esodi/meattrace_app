...
class AuthNotificationService {
  ...
  static void showError(
    ...
    _showNotification(
      ...
      message: message,
      title: title,
      type: AuthNotificationType.error,
      duration: duration,
      onTap: onTap,
    );
  }
  ...
  static void showWarning(
    ...
    _showNotification(
      ...
      message: message,
      title: title,
      type: AuthNotificationType.warning,
      duration: duration,
      onTap: onTap,
    );
  }
  ...
  static void showInfo(
    ...
    _showNotification(
      ...
      message: message,
      title: title,
      type: AuthNotificationType.info,
      duration: duration,
      onTap: onTap,
    );
  }
  ...
  static void showLoading(
    ...
    _showNotification(
      ...
      message: message,
      title: title,
      type: AuthNotificationType.loading,
  ...
  static void _showNotification(
    ...
    String? title,
    required AuthNotificationType type,
    ...
    messenger.showSnackBar(
      SnackBar(
        ...
        elevation: 6,
        action: type != AuthNotificationType.loading
            ? SnackBarAction(
                label: 'Dismiss',
  ...
  static _AuthNotificationConfig _getNotificationConfig(
    ...
    switch (type) {
      ...
      case AuthNotificationType.error:
        return _AuthNotificationConfig(
          icon: Icons.error,
          iconColor: Colors.white,
          iconBackgroundColor: Colors.white.withValues(alpha: 0.2),
      ...
      case AuthNotificationType.warning:
        return _AuthNotificationConfig(
          icon: Icons.warning,
          iconColor: Colors.white,
          iconBackgroundColor: Colors.white.withValues(alpha: 0.2),
      ...
      case AuthNotificationType.info:
        return _AuthNotificationConfig(
          icon: Icons.info,
          iconColor: Colors.white,
          iconBackgroundColor: Colors.white.withValues(alpha: 0.2),
      ...
      case AuthNotificationType.loading:
        return _AuthNotificationConfig(
  ...
  /// Show authentication-specific error messages with user-friendly explanations
